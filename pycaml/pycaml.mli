...
val fast_float_array_to_python : float array -> pyobject
val fast_int_array_to_python : int array -> pyobject
(** Similar to float_array_to_python and int_array_to_python, but try to use
    a NumPy array as output of the conversion, if possible *)
...
val int_items: (int, c_int) kind
val float_items: (float, c_float) kind
val double_items: (float, c_double) kind
