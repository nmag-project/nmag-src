...
(* let _ = Petsc.init Sys.argv "Just a test" "help?";; *)
(* NOTE: this will also init MPI! *)

(* We rather init MPI than have it inited via Petsc... *)
let _ = Mpi.init Sys.argv
...
let _ =
  ...
  (* XXX NOTE: this fails:
     Exception: Mpi.Error "Mpi.scatter: wrong array size".
  *)
...
let _ = Printf.printf "*** Test Finished!\n%!"
;;
