...
(** Care has to be taken when using C manipulators (not functions).
    Here, we must ALWAYS call do_relink_if_necessary immediately
    before we use a manipulator - because other actions 
    related to this module may have caused it to become invalid.
*)
